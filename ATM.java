...
public class ATM {
    ...
    private static void deposit(int index) {
        ...
        accountBalances[index] += amount;
        System.out.println("Deposit successful. New balance: $" + accountBalances[index]);
    }
    ...
    private static void transferMoney(int senderIndex) {
        ...
        System.out.println("Transfer successful. New balance: $" + accountBalances[senderIndex]);
    }
    ...
    private static void billPayments(int index) {
        ...
        System.out.println("Bill payment successful. New balance: $" + accountBalances[index]);
    }
    ...
    private static void mobileRecharge(int index) {
        ...
        System.out.println("Mobile recharge successful. New balance: $" + accountBalances[index]);
    }
    
    private static void languageSelection(int index) {
        System.out.println("Language Selection: (Select language: 1. English, 2. Yoruba, 3. French)");
